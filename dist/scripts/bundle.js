...
var splashPage = React.createClass({displayName: "splashPage",
  render: function() {
    return (
      React.createElement("div", {id: "splash-page"}, 
        ...
        React.createElement("div", {className: "row"}, 
          React.createElement("img", {className: "col-sm-8 offset-sm-2", src: "images/map.png"})
        ), 

        React.createElement("div", {className: "row"}, 
          React.createElement("p", {id: "tagline", className: "text-center col-sm-8 offset-sm-2"}, "Calculate the cost of your trip using your car model, route and favorite gas station.")
        ), 
        ...
        React.createElement("div", {className: "row"}, 
          React.createElement("p", {className: "lead text-center"}, 
            React.createElement(Link, {id: "start-button", to: "currentPositionPage", className: "btn btn-primary btn-lg", role: "button", class: "col-md-8"}, "Get started")
          )
        )
...
var showCheck = function(isSelected) {
  if (isSelected === true) {
    return React.createElement("i", {className: "material-icons checkmark col-sm-2"}, "check");
  }
};
...
var currentPositionPage = React.createClass({displayName: "currentPositionPage",
  render: function() {
    var locations = [
      {
    ...
    return (
      React.createElement("div", {id: "current-position-page"}, 
        React.createElement("div", {className: "row image hero", style: headerStyle}, 
          React.createElement("h2", {className: "text-center"}, "Where are you located?")
        ), 

        
          locations.map(function(location) {
            return (
              React.createElement("div", {className: isSelectedClassName(location.isSelected) + 'location row'}, 
                React.createElement("div", {className: "col-sm-2"}, 
                  React.createElement("i", {className: "material-icons"}, location.symbol)
                ), 
                React.createElement("div", {className: "col-sm-10 address"}, 
                  React.createElement("p", null, location.address), 
                  React.createElement("p", {className: "subtitle"}, location.subtitle)
                ), 
        ...
        React.createElement("div", {className: "row"}, 
          React.createElement(Link, {className: "text-center nextButton btn btn-primary btn-lg", to: "goingPage", role: "button"}, 
            React.createElement("span", null, "Next Step"), 
            React.createElement("i", {className: "material-icons md-36"}, "arrow_forward")
          )
        )
...
var goingPage = React.createClass({displayName: "goingPage",
  render: function() {
    var locations = [
      {
    ...
    return (
      React.createElement("div", {id: "going-page"}, 
        React.createElement("div", {className: "row image hero", style: headerStyle}, 
          React.createElement("h2", {className: "text-center"}, "Where are you going?")
        ), 
        ...
        React.createElement("div", {className: "row"}, 
          React.createElement(Link, {className: "text-center nextButton btn btn-primary btn-lg", to: "vehiclePage", role: "button"}, 
            React.createElement("span", null, "Next Step"), 
            React.createElement("i", {className: "material-icons md-36"}, "arrow_forward")
          )
        )
...
var vehicleInput = React.createClass({displayName: "vehicleInput",
  render: function() {
    return (
      React.createElement("div", {className: "jumbotron"}, 
        React.createElement("h1", null, "Input your car specifications"), 
        React.createElement("p", null, "Then save."), 
        React.createElement("hr", null), 
        React.createElement("p", null), 
          React.createElement("p", {class: "lead"}, 
            React.createElement(Link, {to: "vehiclePage", class: "btn btn-primary btn-lg", role: "button"}, "Cancel")
          ), 
        React.createElement("p", {class: "lead"}, 
          React.createElement(Link, {to: "vehiclePage", class: "btn btn-primary btn-lg", role: "button"}, "Save")
        )
      )
    );
  }
...
var vehiclePage = React.createClass({displayName: "vehiclePage",
  render: function() {
    var cars = [
      {
    ...
    return (
      React.createElement("div", {id: "vehicle-page"}, 
        React.createElement("div", {className: "row image hero", style: headerStyle}, 
          React.createElement("h2", {className: "text-center"}, "What are you driving?")
        ), 

        
          cars.map(function(car) {
            return (
              React.createElement("div", {className: isSelectedClassName(car.isSelected) + 'car row'}, 
                React.createElement("div", {className: "col-sm-2"}, 
                  React.createElement("i", {className: "material-icons"}, "directions_car")
                ), 
                React.createElement("div", {className: "col-sm-10 address"}, 
                  React.createElement("p", null, car.model), 
                  React.createElement("p", {className: "subtitle"}, car.make)
                ), 
        ...
        React.createElement("div", {className: "row"}, 
          React.createElement(Link, {className: "text-center nextButton btn btn-primary btn-lg", to: "gasPage", role: "button"}, 
            React.createElement("span", null, "Next Step"), 
            React.createElement("i", {className: "material-icons md-36"}, "arrow_forward")
          )
        ), 

        React.createElement(Link, {className: "fab", to: "vehicleInput"}, 
          React.createElement("i", {className: "material-icons md-36"}, "add")
        )
...
var gasPage = React.createClass({displayName: "gasPage",
  render: function() {
    var stations = [
      {
        name: 'Shell',
    ...
    return (
      React.createElement("div", {id: "gas-page"}, 
        React.createElement("div", {className: "row image hero", style: headerStyle}, 
          React.createElement("h2", {className: "text-center"}, "What gas station do you frequent?")
        ), 

        
          stations.map(function(station) {
            return (
              React.createElement("div", {className: isSelectedClassName(station.isSelected) + 'station row'}, 
                React.createElement("div", {className: "col-sm-2"}, 
                  React.createElement("i", {className: "material-icons"}, "local_gas_station")
                ), 
                React.createElement("div", {className: "col-sm-10 info"}, 
                  React.createElement("p", null, station.name), 
                  React.createElement("p", {className: "subtitle"}, station.price)
                ), 
        ...
        React.createElement("div", {className: "row"}, 
          React.createElement(Link, {className: "text-center nextButton btn btn-primary btn-lg", to: "summaryPage", role: "button"}, 
            React.createElement("span", null, "Next Step"), 
            React.createElement("i", {className: "material-icons md-36"}, "arrow_forward")
          )
        )
...
var summaryPage = React.createClass({displayName: "summaryPage",
  render: function() {
    return (
      React.createElement("div", {className: "jumbotron"}, 
        React.createElement("h1", null, "You summary!"), 
        React.createElement("p", null), 
        React.createElement("hr", null), 
        React.createElement("p", null), 
          React.createElement("p", {class: "lead"}, 
            React.createElement(Link, {to: "gasPage", class: "btn btn-primary btn-lg", role: "button"}, "Back")
          ), 
        React.createElement("p", {class: "lead"}, 
          React.createElement(Link, {to: "splashPage", class: "btn btn-primary btn-lg", role: "button"}, "New calculation")
        )
      )
    );
  }
...
},{"jquery":2,"react":196,"react-router":27}],205:[function(require,module,exports){
/* globals require, module */
"use strict";
...
var routes = (
 React.createElement(Route, {name: "app", path: "/", handler: require('./components/app')}, 
   React.createElement(DefaultRoute, {handler: require('./components/0-splashPage')}), 
   React.createElement(Route, {name: "currentPositionPage", handler: require('./components/1-currentPositionPage')}), 
   React.createElement(Route, {name: "goingPage", handler: require('./components/2-goingPage')}), 
   React.createElement(Route, {name: "vehiclePage", handler: require('./components/3-vehiclePage')}), 
   React.createElement(Route, {name: "gasPage", handler: require('./components/4-gasPage')}), 
   React.createElement(Route, {name: "summaryPage", handler: require('./components/5-summaryPage')}), 
   React.createElement(Route, {name: "splashPage", handler: require('./components/0-splashPage')}), 
   React.createElement(Route, {name: "vehicleInput", handler: require('./components/3-1-vehicleInput')})
)
);

module.exports = routes;

},{"./components/0-splashPage":197,"./components/1-currentPositionPage":198,"./components/2-goingPage":199,"./components/3-1-vehicleInput":200,"./components/3-vehiclePage":201,"./components/4-gasPage":202,"./components/5-summaryPage":203,"./components/app":204,"react":196,"react-router":27}]},{},[205]);
